...
function IncentiveMeasures() {
  // ฟังก์ชันในการจัดการการเปลี่ยนแปลงค่าของแต่ละฟอร์ม
  ...
  // state ของ inputList ที่มีการกำหนดค่าพื้นฐาน
  const [inputList, setInputList] = useState([
    { accountCode: "", accountName: "", status: "ใช้งาน" },  // ค่าเริ่มต้นของ status คือ "ใช้งาน"
  ]);
  ...
  return (
    <>
      ...
      <Box style={{ margin: '80px 0' }}>
        <Typography variant='h5' textAlign="center">แก้ไขประกาศ</Typography>
        <Grid container md={10} spacing={5} textAlign="center" style={{ margin: "auto" }}> 
          ...
          <Grid item md={12}>
            ...
            <input
              type="file"
              multiple
              onChange={(e) => handleInputChange1(e, 0)}  // ระบุ index สำหรับรายการที่กำลังแก้ไข
              style={{ width: '100%' }}
            />
          </Grid>
        </Grid>
